    ...
    <form method="post" action="../controller/ControllerEditar.php" id="form" name="form"
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="descricao" name="descricao"
                value="<?php echo $editar->getDescricao(); ?>" required>
            <input class="form-control" type="number" id="quantidade" name="quantidade"
                value="<?php echo $editar->getQuantidade(); ?>" required>
            <input class="form-control" type="text" id="preco" name="preco" value="<?php echo $editar->getPreco(); ?>"
                required>
            <select name="flag">
            ...
            <input class="form-control" type="date" id="data" name="data" value="<?php echo $editar->getData(); ?>"
                required>
        </div>
        <div class="form-group">
